  ...
  useEffect(() => {
    ...
    class Particle {
      ...
      constructor() {
        ...
        this.speedX = (Math.random() - 0.5) * performance.speed * 2;
        this.speedY = (Math.random() - 0.5) * performance.speed * 2;
      }
      ...
      draw() {
        if (!ctx) return;
        ctx.fillStyle = `oklch(${primaryColor.l} ${primaryColor.c} ${primaryColor.h} / 0.15)`;
        ctx.beginPath();
